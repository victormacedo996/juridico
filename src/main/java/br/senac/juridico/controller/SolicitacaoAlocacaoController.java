...
public class SolicitacaoAlocacaoController {
	...
	@GetMapping
	public ResponseEntity<List<SolicitacaoAlocacao>> obterSolicitacaoAlocacao(){
		List<SolicitacaoAlocacao> solicitacaoAlocacao = solicitacaoAlocacaoService.buscarSolicitacaoAlocacaoAtivos();
