...
import { RequisitoTemplateService } from 'src/app/services/requisito-template.service';
import { SolicitacaoTipoRequisitoService } from 'src/app/services/solicitacao-tipo-requisito.service';
import { TipoSolicitacaoService } from 'src/app/services/tipo-solicitacao.service';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-solicitacao-analise-juridico',
  templateUrl: './registrar-solicitacao-analise-juridico.component.html',
  styleUrls: ['./registrar-solicitacao-analise-juridico.component.css']
})
export class RegistrarSolicitacaoAnaliseJuridicoComponent implements OnInit {

  constructor(private tipoSolicitacao: TipoSolicitacaoService, private prioridadeService: PrioridadeService, private solicitacaoAnaliseJuridicoService: SolicitacaoAnaliseJuridicoService, private solicitacaoTipoRequisito: SolicitacaoTipoRequisitoService, private requisitoTemplate: RequisitoTemplateService) { }
   ...
   */
  solicitacaoAnaliseJuridico: SolicitacaoAnaliseJuridico = new SolicitacaoAnaliseJuridico;
  ...
  Salvar() {
    ...
    this.solicitacaoAnaliseJuridicoService.registrarSolicitacaoAnaliseJuridico(this.solicitacaoAnaliseJuridico).subscribe(response => {
